...
void _delay(unsigned int t) //@24.000MHz
{
...
void enableFast_RotationVector(unsigned int timeBetweenReports)
{
    setFeatureCommand(SENSOR_REPORTID_GYRO_INTEGRATED_ROTATION_VECTOR, timeBetweenReports, 0);
}
...
{
    long microsBetweenReports = (long)timeBetweenReports;
